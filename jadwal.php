...
<div class="container is-fluid ">
    <div class="notification has-text-centered has-background-primary-light">
        <strong>--Jadwal Anime Per Musim--</strong>
    </div>
</div>
    ...
    <div class="tile is-ancestor">
        <div class="tile is-parent">
            <article class="tile is-child box has-background-info-light">
                <div class="container has-text-centered">
                    <p class="title">Musim Dingin/Winter</p>
                    <p class="subtitle">Mau tahu anime ngetop pada musim dingin? Klik di bawah</p>
                    <div class="buttons has-addons is-centered">
                        <a href="winter.php"><button class="button is-info">Winter</button></a>
                    </div>
                </div>
            </article>
        </div> 
        ...
        <div class="tile is-parent">
            <article class="tile is-child box has-background-danger-light">
                <div class="container has-text-centered">
                    <p class="title">Musim Gugur/Autumn</p>
                    <p class="subtitle">Mau tahu anime ngetop pada musim gugur? Klik di bawah</p>
                    <div class="buttons has-addons is-centered">
                        <a href="#"><button class="button is-danger">Autumn</button></a>
                    </div>
                </div>
            </article>
        </div> 
    ...
    <div class="tile is-ancestor">
        <div class="tile is-parent">
            <article class="tile is-child box has-background-success-light">
                <div class="container has-text-centered">
                    <p class="title">Musim Semi/Spring</p>
                    <p class="subtitle">Mau tahu anime ngetop pada musim semi? Klik di bawah</p>
                    <div class="buttons has-addons is-centered">
                        <a href="#"><button class="button is-success">Spring</button></a>
                    </div>
                </div>
            </article>
        </div> 
        ...
        <div class="tile is-parent">
            <article class="tile is-child box has-background-warning-light">
                <div class="container has-text-centered">
                    <p class="title">Musim Panas/Summer</p>
                    <p class="subtitle">Mau tahu anime ngetop pada musim panas? Klik di bawah</p>
                    <div class="buttons has-addons is-centered">
                        <a href="#"><button class="button is-warning">Summer</button></a>
                    </div>
                </div>
            </article>
        </div> 
